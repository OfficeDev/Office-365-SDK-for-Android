...
public class MailActivity extends Activity implements View.OnClickListener {
    ...
    private Void retrieveMails() {
        ...
        Futures.addCallback(messages, new FutureCallback<List<Message>>() {
            ...
            public void onFailure(final Throwable t) {
                AsyncController.getInstance().handleError(MailActivity.this, t.getMessage());
            }
        });
    ...
    private Void sendToSelf() {
        ...
        if (email.isEmpty()) {
            AsyncController.getInstance().handleError(MailActivity.this, "Please set email address in Settings or edit ServiceConstants");
            return null;
        }
        ...
        try {
            ...
            OutlookClient client =
                    new OutlookClient(
                            ...
                            AuthenticationController.getInstance().getDependencyResolver()
                    );
