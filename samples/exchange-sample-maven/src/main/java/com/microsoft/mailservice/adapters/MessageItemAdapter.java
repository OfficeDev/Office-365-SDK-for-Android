...
public class MessageItemAdapter extends BaseAdapter {
	...
	public MessageItemAdapter(MainActivity activity, MessageCollection messages) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Timestamp date = message.getDateTimeSent();
	...
	public void addMoreItems(MessageCollection collection) {
