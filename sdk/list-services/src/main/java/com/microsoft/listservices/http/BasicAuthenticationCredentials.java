...
import com.microsoft.listservices.Platform;
...
public class BasicAuthenticationCredentials implements Credentials {
	 ...
	 * @throws com.microsoft.listservices.http.BasicAuthenticationCredentials.InvalidPlatformException Throws an exception when invoked on a non-android platform
	 */
