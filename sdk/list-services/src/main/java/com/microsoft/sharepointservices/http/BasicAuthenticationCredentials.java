...
import com.microsoft.sharepointservices.Platform;
...
public class BasicAuthenticationCredentials implements Credentials {
	 ...
	 * @throws com.microsoft.sharepointservices.http.BasicAuthenticationCredentials.InvalidPlatformException Throws an exception when invoked on a non-android platform
	 */
