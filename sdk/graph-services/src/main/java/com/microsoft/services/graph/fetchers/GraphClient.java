...
/**
 * The type GraphClient.
 */
public class GraphClient extends BaseOrcContainer {

     /**
     * Instantiates a new GraphClient.
     *
     * @param url the url
     * @param resolver the resolver
     */
    public GraphClient(String url, DependencyResolver resolver) {
        super(url, resolver);
    }
     ...
     * @return the client
     */
    public GraphClient addParameter(String name, Object value) {
     ...
     * @return the client
     */
    public GraphClient addHeader(String name, String value) {
