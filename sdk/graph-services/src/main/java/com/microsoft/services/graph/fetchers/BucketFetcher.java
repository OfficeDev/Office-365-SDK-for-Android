 ...
 * The type  Bucket
 */
public class BucketFetcher extends OrcEntityFetcher<Bucket,BucketOperations> 
                                     implements Readable<Bucket> {

     /**
     * Instantiates a new BucketFetcher.
     *
     * @param urlComponent the url component
     * @param parent the parent
     */
     public BucketFetcher(String urlComponent, OrcExecutable parent) {
        super(urlComponent, parent, Bucket.class, BucketOperations.class);
    }
     ...
     * @return the fetcher
     */
    public BucketFetcher addParameter(String name, Object value) {
     ...
     * @return the fetcher
     */
    public BucketFetcher addHeader(String name, String value) {
